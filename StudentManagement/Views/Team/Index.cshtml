...
<div class="page-header">
    ...
    <div class="button-group">
        @if (role == "SuperAdmin")
        {
            ...
            <button id="removeTeamBtn" class="remove-team-btn" type="submit" form="removeTeamsForm" disabled>Remove Team</button>
        }
        else
        {
...
else
{
    @if (role == "SuperAdmin")
    {
        <form id="removeTeamsForm" method="post" action="/Team/RemoveSelected">
                    ...
                    @foreach (var team in Model.OrderBy(t => t.Name))
                    {
                        ...
                        <tr>
                            ...
                            <td class="checkbox-cell">
                                <input type="checkbox" class="team-checkbox" name="teamIds" value="@team.Id" onchange="updateRemoveButtonState()" />
                            </td>
                        </tr>
                    }
                </tbody>
